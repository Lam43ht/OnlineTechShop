...
fun DetailScreen(
    ...
    var selectedImageUrl: String by remember { mutableStateOf(item.picUrl.first()) }
        ...
        itemsIndexed (models){ index,model ->
                Box(
                    modifier = Modifier
                        ...
                        .background(
                            if(index == selectedModeIndex) colorResource(R.color.lightGreen) else
                            colorResource(R.color.lightGrey),
                            shape = RoundedCornerShape(10.dp)
                        )
...
fun ImageThumbnail(
    ...
    val backColor = if(isSelected) colorResource(R.color.lightGreen) else
        colorResource(R.color.lightGrey)
